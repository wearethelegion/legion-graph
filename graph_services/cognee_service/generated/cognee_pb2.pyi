...
class SearchRequest(_message.Message):
    __slots__ = ("query", "limit", "dataset_name", "company_id", "search_type", "only_context", "project_id", "branch", "wide_search_top_k", "triplet_distance_penalty", "scope")
    ...
    scope: str
    def __init__(self, query: _Optional[str] = ..., limit: _Optional[int] = ..., dataset_name: _Optional[str] = ..., company_id: _Optional[str] = ..., search_type: _Optional[_Union[SearchType, str]] = ..., only_context: bool = ..., project_id: _Optional[str] = ..., branch: _Optional[str] = ..., wide_search_top_k: _Optional[int] = ..., triplet_distance_penalty: _Optional[float] = ..., scope: _Optional[str] = ...) -> None: ...
...
class FlexibleCogneeSearchRequest(_message.Message):
    __slots__ = ("query", "search_type", "limit", "wide_search_top_k", "triplet_distance_penalty", "only_context", "dataset_name", "branch")
    QUERY_FIELD_NUMBER: _ClassVar[int]
    SEARCH_TYPE_FIELD_NUMBER: _ClassVar[int]
    LIMIT_FIELD_NUMBER: _ClassVar[int]
    WIDE_SEARCH_TOP_K_FIELD_NUMBER: _ClassVar[int]
    ...
    dataset_name: str
    branch: str
    def __init__(self, query: _Optional[str] = ..., search_type: _Optional[_Union[SearchType, str]] = ..., limit: _Optional[int] = ..., wide_search_top_k: _Optional[int] = ..., triplet_distance_penalty: _Optional[float] = ..., only_context: bool = ..., dataset_name: _Optional[str] = ..., branch: _Optional[str] = ...) -> None: ...

class FlexibleCodeSearchRequest(_message.Message):
    __slots__ = ("query", "search_type", "limit", "wide_search_top_k", "triplet_distance_penalty", "only_context", "dataset_name", "branch", "project_id", "project_name")
    QUERY_FIELD_NUMBER: _ClassVar[int]
    SEARCH_TYPE_FIELD_NUMBER: _ClassVar[int]
    LIMIT_FIELD_NUMBER: _ClassVar[int]
    WIDE_SEARCH_TOP_K_FIELD_NUMBER: _ClassVar[int]
    ...
    project_id: str
    project_name: str
    def __init__(self, query: _Optional[str] = ..., search_type: _Optional[_Union[SearchType, str]] = ..., limit: _Optional[int] = ..., wide_search_top_k: _Optional[int] = ..., triplet_distance_penalty: _Optional[float] = ..., only_context: bool = ..., dataset_name: _Optional[str] = ..., branch: _Optional[str] = ..., project_id: _Optional[str] = ..., project_name: _Optional[str] = ...) -> None: ...
