...
class AddToBrainRequest(_message.Message):
    __slots__ = ("kind", "title", "content", "metadata")
    ...
    def __init__(self, kind: _Optional[_Union[BrainContentKind, str]] = ..., title: _Optional[str] = ..., content: _Optional[str] = ..., metadata: _Optional[_Mapping[str, str]] = ...) -> None: ...

class UpdateBrainRequest(_message.Message):
    __slots__ = ("id", "kind", "title", "content", "metadata")
    class MetadataEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    content: str
    metadata: _containers.ScalarMap[str, str]
    def __init__(self, id: _Optional[str] = ..., kind: _Optional[_Union[BrainContentKind, str]] = ..., title: _Optional[str] = ..., content: _Optional[str] = ..., metadata: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class BrainContentResponse(_message.Message):
    __slots__ = ("success", "message", "error_code", "id", "kind", "title", "content_preview", "created_at", "updated_at", "metadata")
    class MetadataEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
