"""Entrypoint for Summarization Service (Service 3).

Usage:
    python -m summarization_service.main
"""
...
from .consumer import SummarizationConsumer
...
async def main() -> None:
    ...
    # Initialize consumer
    consumer = SummarizationConsumer(
        processor=processor,
        config=config,
    )
